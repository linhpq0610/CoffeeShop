<?php 
  define(
    "SEARCH_PRODUCTS_IN_STATISTIC_COMMENT_ROUTE", 
    "tim-kiem-san-pham-trong-thong-ke-binh-luan"
  );
  define("STATISTIC_PRODUCT_ROUTE", "thong-ke-hang-hoa");
  define("STATISTIC_COMMENT_ROUTE", "thong-ke-binh-luan-trang-");
