        ...
        <div class="px-3 pe-lg-5 py-5">
          ...
          <div class="row mt-2">
            <div class="col-md-12">
              ...
              >
              <textarea class="form-control" cols="30" rows="4" name="description" placeholder="VD: Cà phê Arabica tinh khiết được trồng và chăm sóc tận tâm trên những thửa đất phủ đầy cỏ xanh tươi mát..."></textarea>
              <p class="field-message mb-0"></p>
            </div>
          </div>
          <div class="row mt-2">
            <div class="col-md-6">
              ...
              ><input
               type="number" class="form-control" name="price" placeholder="VD: 100000" />
              <p class="field-message mb-0"></p>
            </div>
            <div class="col-md-6">
              <label class="labels">Giảm giá</label
              ><input
               type="number" class="form-control" name="sale" placeholder="VD: 10" />
              <p class="field-message mb-0"></p>
            </div>
          </div>
          <div class="row mt-2">
